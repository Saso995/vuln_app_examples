...
<br/>
The second chall is a really simple website (available at this [link](https://act-chall2.herokuapp.com)).<br/> with a race condition and also vulnerable to stored XSS
